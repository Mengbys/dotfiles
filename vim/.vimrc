...
" set formatoptions+=mM    " Auto line feed when type Chinese
...
if has("gui_running")
  ...
  cd D:\workspace\codemagic\ " Set the work directory for gvim
endif
...
let g:ImSelectSetImCmd = {key -> ['im-select.exe', key]}
